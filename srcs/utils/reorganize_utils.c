...
/*   Updated: 2025/04/22 14:30:16 by rpedrosa         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* @brief: counts the number of arguments were you have a single redirect 
   ...
   @notes: we need to take in consideracion some case will delite multiple args
            echo test > file
...
/* @brief: takes each argument and copys to tmp everything which is not a
	...
	@arguments: tmp is where we save the new argument.
				current is the table we are working on.
				i is used to iterate, inicialize before because of the norm.
